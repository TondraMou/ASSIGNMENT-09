  ...
  return (
    <div className="min-h-[800px] flex items-center justify-center">
      ...
      <div className="bg-gray-600 p-8 rounded-lg shadow-lg w-full max-w-md">
        <h2 className="text-3xl font-bold text-center text-[#caf12d] mb-6">Register</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label htmlFor="photoURL" className="block text-sm font-medium text-white">
              Photo URL
            </label>
            <input
              type="url"
          ...
          <div>
            <label htmlFor="conPassword" className="block text-sm text-white font-medium">
              Confirm Password
            </label>
            <input
              type="password"
        ...
        <div className="mt-4 text-center">
          <p className="text-sm">
            ...
            <a href="/login" className="text-[#caf12d] hover:underline">
              Login
            </a>
          </p>
        </div>
